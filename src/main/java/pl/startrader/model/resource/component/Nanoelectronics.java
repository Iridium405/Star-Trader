...
public class Nanoelectronics extends Resource implements Production {
    ...
    public void addQuantity(Planet planet, Integer quantity, Boolean newlyCreated) {
        if (quantity > 0) {
            ...
            planet.changeQuantity_Nanoelectronics(quantity);
    ...
    public void setDemanded(Planet planet) {
        if(planet.isDemanded_Nanoelectronics().equals(false)) {
            planet.setDemanded_Nanoelectronics(true);
    ...
    public void setNotDemanded(Planet planet) {
        if(planet.isDemanded_Nanoelectronics().equals(true)) {
            planet.setDemanded_Nanoelectronics(false);
