...
//    public static Character getCharacter(String role, String name, Integer criminalConnections, Integer politicalConnections,
...
//                return new Crew(name, criminalConnections, politicalConnections, economicConnections);
//            } else if ("Administrator".equalsIgnoreCase(role)) {
//                return new Administrator(name, criminalConnections, politicalConnections, economicConnections);
//            } else if ("Spy".equalsIgnoreCase(role)) {
//                return new Spy(name, Role.SPY, criminalConnections, politicalConnections, economicConnections);
//            } else {
